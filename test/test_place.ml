         ...
         ; "compare_places"
           >:: begin
                 fun _ ->
                   ...
                   test (-1) "[bar-foo] - baz (boobar)"
                     "[foo-bar] - baz (boobar)";
                   test (-1) "[foo-bar] - baz (boobar)"
                     "[bar-foo] - boobar (baz)";
                   test (-1) "[foo-bar] - ebaz (boobar)"
                     "[bar-foo] - éboobar (baz)";
