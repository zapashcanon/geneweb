...
let sdn_round_trip label to_sdn of_sdn =
  round_trip_aux
    (label ^ " <-> sdn round trip ")
    to_sdn (of_sdn Def.Sure) data_sure
...
let suite =
  [ "Calendar"
    >::: []
         ...
         @ gregorian_round_trip "julian" Calendar.gregorian_of_julian
             Calendar.julian_of_gregorian
         @ gregorian_round_trip "french" Calendar.gregorian_of_french
             Calendar.french_of_gregorian
         @ gregorian_round_trip "hebrew" Calendar.gregorian_of_hebrew
             Calendar.hebrew_of_gregorian
  ]
