                  ...
                  List.fold_left
                    begin
                      fun acc istr ->
                        ...
                        if eq (List.map Name.lower @@ split str) then
                          istr :: acc
                        else acc
                    end
                    [] istrs
